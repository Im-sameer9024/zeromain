...
const UserForm = () => {
  ...
  const handleSubmit = userInfo?.handleSubmit;
  const register = userInfo?.register;
  const errors = userInfo?.errors;
  const onSubmit = userInfo?.onSubmit;
  const isSubmitting = userInfo?.isSubmitting;
  ...
  return (
    <div className="w-full flex justify-center items-center">
      ...
      >
        <h2 className=" text-center font-bold text-xl">User </h2>
